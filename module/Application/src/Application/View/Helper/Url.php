...
class Url extends AbstractHelper
{
     ...
     * @param  bool                 $ajaxfunction       return link in function inside for ajax
     ...
     */
    public function __invoke($name = null, $params = array(), $options = array(), $reuseMatchedParams = false, $ajaxfunction = true)
    {
        if (null === $this->router) {
