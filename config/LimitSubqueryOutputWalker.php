...
class LimitSubqueryOutputWalker extends SqlWalker
{
    ...
    public function walkSelectStatementWithoutRowNumber(SelectStatement $AST, $addMissingItemsFromOrderByToSelect = true)
    {
        ...
        $sql = $this->preserveSqlOrdering($sqlIdentifier, $innerSql, $sql, $orderByClause, $AST);
     ...
     * @return string
     */
    private function preserveSqlOrdering(array $sqlIdentifier, $innerSql, $sql, $orderByClause, SelectStatement $AST)
    {
        ...
        // INICIO DA COPIA DO TRECHO DA VERSAO ANTIGA DOCTRINE 0.9.0.1
       /**
        * Esta solução se resume a remover a clausula order by do select distintic
        * @author Paulo Watakabe <watakabe05@gmail.com>
        * @since 11-04-2016 Removed orderBy beacause have problems for by order with join tables. 
        * 
        */
        ...
        // FIM DA COPIA DO TRECHO DA VERSAO ANTIGA DOCTRINE 0.9.0.1

        /**
        * TRECHO ORIGINAL COM PROBLEMA DE JOIN
        * @author Paulo Watakabe <watakabe05@gmail.com>
        * @since 11-04-2016 Removed orderBy beacause have problems for by order with join tables. 
         * REMOVED BECAUSE DONT SUPORTE JOIN CLAUSURE
